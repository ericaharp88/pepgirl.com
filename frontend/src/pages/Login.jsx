  ...
  return (
    <div className="max-w-md mx-auto px-6 py-24">
      <div className="border-b border-[#0A0A0A] pb-4 mb-8">
        <div className="eyebrow text-[#B87A6A] mb-3">Restricted</div>
      ...
      <form onSubmit={submit} className="space-y-6" data-testid="login-form">
        ...
        <Button
          ...
          className="w-full rounded-none bg-[#B87A6A] hover:bg-[#0A0A0A] text-white h-12 font-mono uppercase tracking-[0.25em] text-xs"
        >
